...
<!--Listing Placed Orders-->
    ...
    <table class="table table-bordered table-hover table-striped" id="list_orders_tbl">
        <thead>
        ...
        <?php foreach ($orders as $order) { 
          $ledger_url = base_url().'order/view_orders/'.$order['order_id'];?>
              ...
              <td><a href="<?php echo $ledger_url ?>">View</a><span class="divider"> </td>
        <?php }?>
              </tr>
...
<!--Listing Rejected Orders-->
  ...
  <table class="table table-bordered table-hover table-striped" id="list_rejected_orders_tbl">
        <thead>
